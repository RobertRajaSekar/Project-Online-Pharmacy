...
import com.jsp.Pharmacy.Application.exception.MedicineNameNotFoundException;
...
//			medicine  is not present
			throw new MedicineNameNotFoundException("Sorry failed to find the medicine by name");
		}
	}
}
